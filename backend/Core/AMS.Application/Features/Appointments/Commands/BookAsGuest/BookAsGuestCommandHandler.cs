...
{
    public class BookAsGuestCommandHandler : ResponseHandler, IRequestHandler<BookAsGuestCommand, Response<int?>>
    {
        private readonly IAppointmentRepository _appointmentRepository;
        private readonly IDoctorRepository _doctorRepository;
        private readonly AppointmentSettings _appointmentSettings;

        public BookAsGuestCommandHandler(IAppointmentRepository appointmentRepository, IDoctorRepository doctorRepository, IOptionsSnapshot<AppointmentSettings> appointmentSettings)
        {
        ...
        public async Task<Response<int?>> Handle(BookAsGuestCommand request, CancellationToken cancellationToken)
        {
            ...
            bool hasOverlap = await _appointmentRepository.HasOverlappingAppointment(request.DoctorId,null, request.AppointmentDate, request.StartTime, EndTime, request.EmailAddress);
            ...
            var appointment = new Appointment
            {
                ...
                GuestEmail = request.EmailAddress,
